...
class AirClient(object):
    ...
    def get_status(self, debug=False, output=True):
        url = 'http://{}/di/v1/products/1/air'.format(self._host)
    ...
    def get_firmware(self, output=True):
    ...
    def get_filters(self, output=True):
        ...
        if 'wicksts' in filters and output:
